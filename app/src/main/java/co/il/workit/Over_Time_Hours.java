...
public class Over_Time_Hours extends AppCompatActivity implements View.OnClickListener
{
    Button btnWI;
    Button btnCS;
    Button btnMS;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.overtimehours);
    ...
    public void onClick(View v)
    {
        ...
        if (btnSave == v)
        {
            if(et4H.getText().length()>0)
            {
                ...
                MainActivity.over_time = Integer.parseInt(et4H.getText().toString());
